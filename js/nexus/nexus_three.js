function NexusObject(url, renderer, render, material, notify) {
...
NexusObject.prototype.raycast = function(raycaster, intersects) {
	...
	for(var i = 0; i < nexus.sink; i++) {
        ...
        //nexus.raycast(raycaster, intersects);
	}
